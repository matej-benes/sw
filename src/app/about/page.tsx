        ...
        <div className="bg-background text-foreground">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between bg-background/80 px-6 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-4">
                    <Button variant="ghost" onClick={() => router.push('/')}>Přihlásit se</Button>
                    <Button onClick={() => router.push('/')}>Registrovat se</Button>
                </div>
            </header>
                ...
                <section className="py-20 text-center">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="mt-8 flex justify-center gap-4">
                            <Button size="lg" onClick={() => router.push('/')}>Vyzkoušet zdarma</Button>
